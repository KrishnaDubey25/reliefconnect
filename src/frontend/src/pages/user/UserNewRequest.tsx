...
export default function UserNewRequest() {
  ...
  return (
    ...
    >
      ...
      {/* Desktop: Step indicator alongside form */}
      <div className="flex flex-col lg:flex-row gap-6">
        {/* Desktop sidebar: step tracker */}
        <div className="hidden lg:flex lg:flex-col lg:w-48 xl:w-56 shrink-0 gap-1 pt-1">
          ...
          <div className="mt-6 p-3 rounded-xl bg-muted/40 border border-border space-y-2">
            <p className="text-xs font-semibold text-muted-foreground uppercase tracking-wide">
              Summary
            </p>
            <div className="flex items-center gap-2 text-xs">
              <ResourceIcon type={resourceType} size={14} />
              <span className="capitalize text-foreground font-medium">
                {t(`resources.${resourceType}`, { defaultValue: resourceType })}
              </span>
            </div>
                  ...
                  {[
                    ...
                    return (
                      <button
                        ...
                        className={`flex items-center gap-3 px-4 py-3 rounded-xl border text-left transition-smooth flex-1 ${
                          isSelected
                      ...
                      >
                        ...
                        <div className="min-w-0 flex-1">
                          ...
                          <span className="ml-2 text-xs opacity-75 lg:hidden">
                            {meta.description}
                          </span>
