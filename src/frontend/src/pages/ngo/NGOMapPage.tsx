...
export default function NGOMapPage() {
  ...
  return (
    <div className="space-y-5 pb-6" data-ocid="ngo_map.page">
      {/* Header */}
      ...
      {/* Desktop: map + right sidebar / Mobile: stacked */}
      <div className="flex flex-col lg:flex-row gap-5 items-start">
        {/* Left: map + urgency summary */}
        ...
        {/* Right sidebar: filter + request list (desktop) */}
        <div className="w-full lg:w-72 shrink-0 space-y-4">
          ...
          <div className="space-y-2">
            <h2 className="text-sm font-semibold px-0.5">
            ...
            {loadingReq || loadingNGO ? (
              ...
              <div className="space-y-2 max-h-96 lg:max-h-[520px] overflow-y-auto pr-0.5">
