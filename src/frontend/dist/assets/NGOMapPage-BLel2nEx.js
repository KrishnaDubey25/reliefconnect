import { y as createLucideIcon, m as useBackend, D as useAuth, J as useQueryClient, a as useTranslation, r as reactExports, N as UrgencyLevel, j as jsxRuntimeExports, o as Button, q as CircleAlert, B as Badge, E as Skeleton, R as RequestStatus } from "./index-CiAbU5FG.js";
...
import { F as Funnel } from "./funnel-XYrZ6OUu.js";
...
function NGOMapPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-5 pb-6", "data-ocid": "ngo_map.page", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col lg:flex-row gap-5 items-start", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0 space-y-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-3 gap-2", children: urgencyItems.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            type: "button",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full lg:w-72 shrink-0 space-y-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card border border-border rounded-xl p-4 space-y-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1 text-xs text-muted-foreground font-medium", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Funnel, { size: 12 }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Filter by Urgency" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-1.5", children: filterOptions.map((f) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              type: "button",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-sm font-semibold px-0.5", children: t("ngoRequests.tabOpen") }),
          loadingReq || loadingNGO ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2", children: [1, 2, 3].map((i) => /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-16 w-full rounded-xl" }, i)) }) : filteredRequests.length > 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2 max-h-96 lg:max-h-[520px] overflow-y-auto pr-0.5", children: filteredRequests.map((req, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
