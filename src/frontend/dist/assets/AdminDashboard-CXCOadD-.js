import { m as useBackend, a as useTranslation, j as jsxRuntimeExports, B as Badge, E as Skeleton, ab as Users, w as Building2, b as Link, d as ArrowRight } from "./index-CiAbU5FG.js";
...
function AdminDashboard() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", "data-ocid": "admin_dashboard.page", children: [
    ...
    isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-3", children: ["a", "b", "c", "d", "e", "f"].map((k) => /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-28 rounded-xl" }, k)) }) : /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        StatCard,
        {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      Card,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: loadingVerification ? /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-12 w-full" }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 md:grid-cols-4 gap-4 lg:gap-6", children: [
            {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
            ...
            "div",
            {
              ...
              children: [
                ...
                loadingRequests ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2", children: ["a", "b", "c", "d", "e"].map((k) => /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-14 rounded-lg" }, k)) }) : recentRequests.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "hidden lg:grid lg:grid-cols-[2rem_1fr_6rem_5rem_8rem] gap-3 px-4 py-2 text-xs font-medium text-muted-foreground border-b border-border", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", {}),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: t("adminRequests.resource") }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-right", children: "Qty" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-center", children: t("adminRequests.status") }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-right", children: t("adminRequests.created") })
                  ] }),
                  recentRequests.map((req, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "div",
                    {
                      ...
                      children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-7 w-7 lg:h-6 lg:w-6 rounded-md bg-muted flex items-center justify-center shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ResourceIcon, { type: req.resourceType, size: 13 }) }),
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs font-medium capitalize truncate", children: [
                            req.resourceType,
                            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "lg:hidden", children: [
                              " ",
                              "· ",
                          ...
                          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] text-muted-foreground truncate lg:hidden", children: new Date(
                            Number(req.createdAt) / 1e6
                          ).toLocaleString() })
                        ] }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "hidden lg:block text-xs tabular-nums text-muted-foreground text-right", children: req.quantity.toString() }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "hidden lg:flex justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(StatusBadge, { status: req.status, size: "sm" }) }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "hidden lg:block text-[10px] text-muted-foreground text-right", children: new Date(
                          Number(req.createdAt) / 1e6
                        ).toLocaleDateString() }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "lg:hidden ml-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsx(StatusBadge, { status: req.status, size: "sm" }) })
                      ]
                    },
                    req.id.toString()
                  ))
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "lg:w-72 xl:w-80 space-y-4 shrink-0", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              Card,
              {
                className: "border-border",
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "space-y-2", children: isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-10 w-full" }) : /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between py-2 border-b border-border", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground", children: t("adminDashboard.stats.totalNGOs") }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-bold", children: ((analytics == null ? void 0 : analytics.totalNGOs) ?? 0n).toString() })
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between py-2 border-b border-border", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground", children: t("adminDashboard.stats.totalUsers") }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-bold", children: ((analytics == null ? void 0 : analytics.totalUsers) ?? 0n).toString() })
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between py-2", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground", children: t("adminDashboard.stats.delivered") }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-bold text-secondary", children: ((analytics == null ? void 0 : analytics.deliveredRequests) ?? 0n).toString() })
                    ] })
                  ] }) })
                ]
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { "data-ocid": "admin_dashboard.quick_nav.section", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-xs font-semibold text-muted-foreground mb-2 uppercase tracking-wide", children: "Quick Access" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 gap-2", children: [
                ...
                Link,
                {
                  ...
                  children: /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "border-border hover:shadow-md transition-smooth cursor-pointer", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "p-3 flex items-center gap-2", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { size: 14, className: "text-primary shrink-0" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-medium truncate", children: label })
                  ] }) })
                },
                label
              )) })
