import { y as createLucideIcon, m as useBackend, D as useAuth, a as useTranslation, R as RequestStatus, j as jsxRuntimeExports, B as Badge, S as Shield, G as Phone, E as Skeleton, b as Link, d as ArrowRight, O as RESOURCE_TYPES } from "./index-Cru0WlOf.js";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        ...
        activeRequests.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", "data-ocid": "ngo_dashboard.active_section", children: [
            ...
            return /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                children: [
                  ...
                  req.status === RequestStatus.inTransit && /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheck, { size: 16, className: "text-secondary shrink-0" })
                ]
              },
              req.id.toString()
            );
          }),
          activeRequests.length > 3 && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground text-center", children: t("ngoDashboard.moreTasks", {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/ngo/requests", "data-ocid": "ngo_dashboard.requests_link", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "border-border bg-card hover:bg-muted/30 transition-smooth group", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "p-4 flex items-center gap-4", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-0.5", children: t("ngoDashboard.requestsDesc") })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 shrink-0", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/ngo/inventory", "data-ocid": "ngo_dashboard.inventory_link", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "border-border bg-card hover:bg-muted/30 transition-smooth group", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "p-4 flex items-center gap-4", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-0.5", children: t("ngoDashboard.inventoryDesc") })
                ] }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", "data-ocid": "ngo_dashboard.inventory_section", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "text-sm font-semibold flex items-center gap-2", children: [
