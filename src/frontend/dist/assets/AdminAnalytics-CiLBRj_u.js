import { m as useBackend, a as useTranslation, M as ResourceType, j as jsxRuntimeExports, E as Skeleton, an as ChartColumn, aa as Users, O as RESOURCE_TYPES } from "./index-Cru0WlOf.js";
import { C as Card, a as CardContent, b as CardHeader, c as CardTitle } from "./card-RqapHmT1.js";
import { u as useQuery } from "./useQuery---NWOs32.js";
import { C as CircleCheck } from "./circle-check-CDfIVQDZ.js";
import { T as TrendingUp } from "./trending-up-DiyqRAeX.js";
function BarRow({
  label,
  value,
  max,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        Card,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: loadingRequests ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3", children: ["a", "b", "c", "d"].map((k) => /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-8 w-full" }, k)) }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-4", children: RESOURCE_TYPES.map((rt, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              BarRow,
              {
                label: t(rt.labelKey),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        Card,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: loadingAnalytics ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3", children: ["a", "b", "c", "d"].map((k) => /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-8 w-full" }, k)) }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-4", children: [
              {
                label: t("status.open"),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        Card,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: loadingVerification ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3", children: ["a", "b", "c", "d"].map((k) => /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-6 w-full" }, k)) }) : /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-lg", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                VerifBreakdown,
                {
                  both: bothDeclared,
