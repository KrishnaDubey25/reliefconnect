...
import { M as Minus, P as Plus } from "./plus-bJqHHwrH.js";
...
function UserNewRequest() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-lg mx-auto pb-10", "data-ocid": "user_new_request.page", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mb-6", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-xl font-display font-bold text-foreground leading-tight", children: t("userNewRequest.title") }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        Card,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "px-4 pb-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 gap-2", children: RESOURCE_TYPES.map((rt, idx) => {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        Card,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "px-4 pb-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col gap-2", children: [UrgencyLevel.high, UrgencyLevel.medium, UrgencyLevel.low].map(
              (level) => {
                ...
                return /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "button",
                  {
                    ...
                    className: `flex items-center gap-3 px-4 py-3 rounded-xl border text-left transition-smooth ${isSelected ? `border-2 ${meta.activeBorder}` : "border-border hover:bg-muted/50"}`,
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0 flex-1", children: [
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "ml-2 text-xs opacity-75", children: meta.description })
                      ] }),
