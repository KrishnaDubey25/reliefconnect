import { u as useNavigate, a as useTranslation, j as jsxRuntimeExports, A as ArrowLeft, L as LanguageSwitcher, b as Link, c as APP_NAME, B as Badge, d as ArrowRight } from "./index-CiAbU5FG.js";
...
function RegisterPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-background flex flex-col", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative flex flex-col flex-1 items-center px-4 py-8 lg:py-12", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full max-w-3xl lg:max-w-5xl mb-8 flex items-center justify-between", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-sm text-muted-foreground hidden sm:block", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-10 lg:mb-12", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-3xl lg:text-4xl font-display font-bold text-foreground tracking-tight", children: t("register.title", { appName: APP_NAME }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground mt-2 max-w-md lg:max-w-lg lg:text-base", children: t("register.subtitle") })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-full max-w-3xl lg:max-w-5xl grid grid-cols-1 sm:grid-cols-3 lg:grid-cols-3 gap-5 lg:gap-8", children: ROLES.map((card) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          type: "button",
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-4xl lg:text-5xl", children: card.icon }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: card.badgeVariant, className: "text-xs", children: t(card.badgeKey) })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-lg lg:text-xl font-display font-semibold text-foreground", children: t(card.titleKey) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground mt-1 leading-relaxed", children: t(card.descKey) })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "flex flex-col gap-1.5 lg:gap-2 flex-1", children: card.featureKeys.map((fk) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "li",
              {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full mt-auto flex items-center justify-center gap-1.5 rounded-md border border-border bg-transparent px-4 py-2 lg:py-2.5 text-sm font-medium group-hover:bg-primary group-hover:text-primary-foreground group-hover:border-primary transition-smooth pointer-events-none", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "mt-6 text-sm text-muted-foreground sm:hidden", children: [
        t("register.alreadyRegistered"),
        " ",
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Link,
